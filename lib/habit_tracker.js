...
class HabitTracker {
  ...
  static makeHabitTracker(rawHabitTracker) {
    let tracker = new HabitTracker();
    rawHabitTracker.habits.forEach(habit => tracker.add(Habit.makeHabit(habit)));
    tracker.totalScore = rawHabitTracker.totalScore || 0;
    return tracker;
  }
}
